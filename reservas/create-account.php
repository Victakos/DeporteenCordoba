...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            ...
            $database->query("insert into usuarios(pemail,pname,ppassword, paddress, pnic,pdob,ptel) values('$email','$name','$newpassword','$address','$nic','$dob','$tele');");
            $database->query("insert into webuser values('$email','p')");

            //print_r("insert into usuarios values($pid,'$email','$fname','$lname','$newpassword','$address','$nic','$dob','$tele');");
            $_SESSION["user"]=$email;
            $_SESSION["usertype"]="p";
        ...
        <table border="0" style="width: 80%;">
            <tr>
                <td colspan="2">
                    ...
                    <p class="sub-text">Genial, continua creando tu cuenta</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <label for="tele" class="form-label">Nº Tlf: (opcional) </label>
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
                    <input type="tel" name="tele" class="input-text"  placeholder="ej: 672..... " >
                </td>
            </tr>
            <tr>
                <td class="label-td" colspan="2">
            ...
            <tr>
                <td colspan="2">
                    <br>
                    <label for="" class="sub-text" style="font-weight: 280;">Ya tienes cuenta&#63; </label>
                    <a href="login.php" class="hover-link1 non-style-link">Inicia sesión</a>
                    <a href="#" aria-label="logo"><img src="images/logo.png" alt="Logo deporte en Córdoba" class="logo" style="width: 450px;padding: 1rem;"></a>
                    <br><br><br>
                </td>
            </tr>
