                            ...
                            <tr>
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        <div class="btn-icon-back dashboard-icons-setting" style="background-image: url('#');"></div>
                                        <div>
                                                ...
                                                <div class="h3-dashboard" style="font-size: 15px;">
                                                    Editar cuenta - cambio de contraseña
                                                </div>
                                        </div>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            ¿Quieres borrar tu cuenta?<br>('.substr($nameget,0,40).').
