                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Buscar clubes por nombre o email" list="clubes" >&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            if(($_GET)){
                                ...
                                if(isset($_GET["id"])){
                                    ...
                                    $sqlmain= "select * from schedule inner join clubes on schedule.docid=clubes.docid where schedule.scheduleid=$id  order by schedule.scheduledate desc";
                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        Nombre del club:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            email del club:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;">
                                                            Deporte: '.$title.'<br>
                                                            Día de reserva: '.$scheduledate.'<br>
                                                            Hora : '.$scheduletime.'<br>
                                                            Canal de reserva : <b>Página web</b>
